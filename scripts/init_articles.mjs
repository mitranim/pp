...
export function init() {
  return new u.ListPkDesc(
    ...
    new s.PageArticle({
      ...
      createdAt: new Date(`2015-09-21T20:45:27.000Z`),
    }),
    new s.PageArticle({
      id: 6,
      slug: `elros-advice`,
      ...
      createdAt: new Date(`2015-09-29T21:13:36.000Z`),
    }),
    new s.PageArticle({
      id: 7,
      slug: `maltsev_wisdom`,
      ...
      createdAt: new Date(`2015-10-08T07:58:44.658Z`),
    }),
    new s.PageArticle({
      id: 8,
      slug: `10-truths`,
      ...
      createdAt: new Date(`2015-10-31T13:25:26.546Z`),
    }),
    new s.PageArticle({
      id: 9,
      slug: `three-whale`,
      ...
      createdAt: new Date(`2015-11-14T20:48:12.890Z`),
    }),
    new s.PageArticle({
      id: 10,
      slug: `classic_style`,
      ...
      createdAt: new Date(`2015-12-12T20:00:51.997Z`),
    }),
    new s.PageArticle({
      id: 11,
      slug: `3poi`,
      ...
      createdAt: new Date(`2016-03-11T20:33:17.258Z`),
    }),
    new s.PageArticle({
      id: 12,
      slug: `contact`,
...
•	Контактный поинг`,
      ...
      createdAt: new Date(`2016-05-12T16:18:41.886Z`),
    }),
    new s.PageArticle({
      id: 13,
      slug: `poispiner`,
      ...
      createdAt: new Date(`2016-05-17T20:54:33.781Z`),
    }),
  ).norm()
}
